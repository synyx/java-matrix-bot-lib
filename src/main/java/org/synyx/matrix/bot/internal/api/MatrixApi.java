...
public class MatrixApi {
    ...
    public boolean sendEvent(String roomId, String eventType, Object event) {
    ...
    public boolean joinRoom(String roomId, String reason) {
    ...
    public boolean leaveRoom(String roomId, String reason) {
